...
CREATE TABLE CLIENTE (
    ...
    FECREGCLI timestamp NOT NULL COMMENT 'Fecha de registro de cliente',
    FECHMODCLI timestamp NOT NULL COMMENT 'Fecha de modificacion de registro de cliente',
...
CREATE TABLE FACTURA_CABECERA (
    ...
    FECFACCAB timestamp NOT NULL COMMENT 'Fecha de registro de factura cabecera',
...
CREATE TABLE PRODUCTO (
    ...
    FECPRO timestamp NOT NULL COMMENT 'Fecha de registro del producto',
...
ALTER TABLE PRODUCTO ADD CONSTRAINT PRODUCTO_CATEGORIA FOREIGN KEY PRODUCTO_CATEGORIA (CATEGORIA_IDCAT)
    REFERENCES CATEGORIA (IDCAT);

-- End of file.

INSERT INTO CLIENTE (NOMCLI, APECLI,ESTCLI,FECREGCLI,FECHMODCLI) VALUES ('Joseph','Florian','ACTIVO',SELECT NOW(),SELECT NOW(),'Aprobado');
